...
const CATEGORY = [
    ...
    { name: 'prose', icon: `<i class="fas fa-book-open icon"></i>` },
    { name: 'romance', icon: `<i class="fas fa-seedling icon"></i>` },
    { name: 'fantasy', icon: `<i class="fab fa-servicestack icon"></i>` },
    { name: 'comedy', icon: `<i class="fas fa-grin-squint-tears icon"></i>` },
    ...
    { name: 'horror', icon: `<i class="fas fa-skull icon"></i>` }
];
